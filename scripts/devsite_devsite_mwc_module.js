...
_ds.hE(a);return b}});var oX=function(a){return a.label?(0,_ds.L)`<span
    ...
    >`:_ds.Cu},pX=function(a){return a.icon?(0,_ds.L)`<span class="devsite-mwc-text-field__icon" aria-hidden="true">
      ...
      </span>`},qX=class extends _ds.Cv{static get styles(){return oJa}constructor(){super();this.readOnly=!1;this.kind="";this.type="text";this.disabled=this.warning=this.required=this.outlined=!1;this.name=this.value=this.placeholder=this.icon=this.label="";this.invalid=this.focused=!1;this.rows=2;this.cols=20;this.maxLength=this.minLength=-1;this.charCounter=!1;this.staticPath="";this.options=[]}m(a){super.m(a);(a=Array.from(this.querySelectorAll("option")).map(b=>({value:b.value,text:b.text,disabled:b.disabled})))&&
...
"devsite-mwc--outlined":this.outlined,"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--warning":this.warning,"devsite-mwc--floating":this.value!==""||this.focused}),b=oX(this),c=pX(this);var d=this.minLength===-1?void 0:this.minLength;const e=this.maxLength===-1?void 0:this.maxLength;d=(0,_ds.L)` <input
      ...
      minlength="${d!=null?d:_ds.Cu}"
      maxlength="${e!=null?e:_ds.Cu}"
    ...
    `;case "select":a:{for(a of this.options)if(a.value.trim()===this.value.trim()){a=a.text.trim();break a}a=""}return(0,_ds.L)`
      <label class="devsite-mwc-select ${(0,_ds.Ct)({"devsite-mwc--disabled":this.disabled,"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":a!==""||this.focused})}">
        ${oX(this)} ${pX(this)}
        ${pJa(this)}
      </label>
    `;case "textarea":return a=(0,_ds.Ct)({"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":this.value!==""||this.focused}),b=oX(this),c=this.minLength===-1?void 0:this.minLength,d=this.maxLength===-1?void 0:this.maxLength,c=(0,_ds.L)`<textarea
      ...
      cols="${this.cols}"
      name="${_ds.xI(this.name===""?void 0:this.name)}"
      minlength="${c!=null?c:_ds.Cu}"
      maxlength="${d!=null?d:_ds.Cu}"
      @input="${this.oa}"
      @blur="${this.ea}"
      @focus="${this.qa}"
      ...
      ${!this.charCounter&&this.maxLength?_ds.Cu:(0,_ds.L)`<span class="devsite-mwc-character-counter"
